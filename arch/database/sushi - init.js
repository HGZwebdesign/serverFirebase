/**
 * -----------------------------------------------------------------------
 *                       Snapshot of firebase init PUSH
 * -----------------------------------------------------------------------
 */

let ref999 = firebase.database().ref("sushi/");
...
ref999.push({
  name: "Sashimi roll",
  description:
    "Sashimi roll to sushi bez ryżu. Są to kawałki surowej i świeżej ryby wraz z warzywami zawinięte w papier ryżowy.",
  size: 2,
  editable: false,
  id: firebase.database.ServerValue.TIMESTAMP,
});
